...
import { FACILITIES } from '../../constants/schoolData';
    ...
    <TranslateText>
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600">{facility.description}</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <motion.div
              ...
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6, delay: 0.3 }}
              className="bg-blue-50 rounded-2xl shadow-lg p-8 sticky top-24"
            >
              ...
              {/* CTA */}
              <button
                onClick={() => window.location.href = 'mailto:info@baldodh.edu.np?subject=Facility%20Inquiry'}
                className="w-full mt-8 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-semibold"
              >
